...
X_norm, y_fault, y_type, indices_norm = pf.get_L2_norms(data, cols=useful_cols)
...
for k, v in kernels.items():
    file_name = 'norm_' + k + '_5fold'
    pf.run_and_save_1D(X_norm, y_fault, y_type, indices_norm, cv, v, 
             x_logit, x_logit, 0.3, s3, '..\\temp', 'model-results/gpc', file_name)
