...
##########
# STEP 3 - COMPONENT SUBSET FOR LATER USE
##########
...
for bins in range(2,9):
    X_BOSS, y_fault, y_type, indices_BOSS = pf.get_bow_results(data, cols=useful_cols, reshape=10, method='boss', n_bins=bins)
    for k, v in kernels.items():
        file_name = 'BOSS_' + k + '_' + str(bins) + '_5fold'
        pf.run_and_save_2D(X_BOSS, y_fault, y_type, indices_BOSS, cv, v, 
